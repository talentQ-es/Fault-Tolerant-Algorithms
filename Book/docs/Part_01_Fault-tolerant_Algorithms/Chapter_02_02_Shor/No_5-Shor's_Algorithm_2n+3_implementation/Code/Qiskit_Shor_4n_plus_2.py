...
Exameples:
    ...
    python Qiskit_Shor_4n_plus_2.py -N 15 -a 7
    python Qiskit_Shor_4n_plus_2.py -N 15 -a 7 -shots_execution 5
    python Qiskit_Shor_4n_plus_2.py -N 15 -approx 2
    python Qiskit_Shor_4n_plus_2.py -N 15 -shots 5 -approx 2
...
if a == 0 :
    ...
    while No_factors:
        ...
        No_factors, factors, new_N = sf.simulation_4n_plus_2(a,new_N, N, 
    ...
    while No_factors:
        ...
        No_factors, factors, new_N = sf.simulation_4n_plus_4(a, new_N, N, 
                                     factors, shots_per_execution , 
                                     max_shots = a_shots,
                                     approx_QFT = approx_QFT,
                                     gpu = gpu, cuQuantum = cuQuantum) #method